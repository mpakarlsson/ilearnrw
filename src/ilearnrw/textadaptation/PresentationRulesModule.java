...
public class PresentationRulesModule implements PresentationRules, Serializable{
	 ...
	 */
	public void setTextColor(int i, int j, String textColor)
	{
	 ...
	 */
	public String getTextColor(int i, int j)
	{
	 ...
	 */
	public void setHighlightingColor(int i, int j, String highlightingColor)
	{
	 ...
	 */
	public String getHighlightingColor(int i, int j)
	{
