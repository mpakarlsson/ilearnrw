...
public class StringMatchesInfoTest {
	...
	public static void runOnceBeforeAnything(){
		...
		ew1 = new EnglishWord("absorbing", "əb.ˈzɔːb.ɪŋ", "absorb",
				...
				new String[] { "ab", "sorb", "ing"},
				"ing", "SUFFIX_ADD", "ab", "PREFIX_VISUAL", 3, 5001, WordType.Unknown);
		...
		ew2 = new EnglishWord("angle", "ˈæŋ.ɡəl", "angle",
				...
				new String[] { "an", "gle" },
				"NULL", "SUFFIX_NONE", "NULL", "PREFIX_NONE", 2, 5001, WordType.Unknown);
		...
		ew4 = new EnglishWord("bee's", "biːz", "bee",
				...
				new String[] { "bee's" },
				"'s", "SUFFIX_ADD", "NULL", "PREFIX_NONE", 1, 5001, WordType.Unknown);
		...
		ew5 = new EnglishWord("psychology", "saɪˈk.ɒ.lə.dʒi", "psychology",
				...
				new String[] { "psych", "o", "lo", "gy" },
				"NULL", "SUFFIX_NONE", "NULL", "PREFIX_NONE", 4, 5001, WordType.Unknown);
		...
		ew7 = new EnglishWord("tablespoon", "ˈteɪ.bl.spuːn", "tablespoon",
				...
				new String[] { "ta", "ble", "spoon" },
				"NULL", "SUFFIX_NONE", "NULL", "PREFIX_NONE", 3, 5001, WordType.Unknown);
	}
